...
const Searchbox = ({ setsearchBox, buttonRef }) => {
  ...
  return (
    <div className="searchBox" ref={buttonRef}>
      <div className="searchBoxHeader w-full d-flex justify-content-between align-items-center">
        <svg
          fill="currentColor"
          viewBox="0 0 20 20"
          width="1.4em"
      ...
      <div className="searchUserData my-2">
