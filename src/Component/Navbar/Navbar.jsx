...
export const Navbar = () => {
  ...
  const handleItemClick = (index) => {
    ...
    sessionStorage.setItem("activeIndex", index); // Store the active index in local storage
  };
  useEffect(() => {
  ...
  return (
    <>
      <nav className="d-flex justify-content-between align-items-center w-full">
        <div className="logoWithSearch d-flex justify-content-start align-items-center p-0 col-6 col-md-3">
          <NavLink className="logo" to="/" onClick={() => handleItemClick(1)}>
            <img src={Logo} alt="" />
          </NavLink>
          <div
          ...
          >
            ...
            <input type="search" name="" placeholder="Search Facebook" id="" />
          </div>
          <NavLink
            to="/bookmarks"
            className={
              activeIndex === 5
                ? "Icon activate  d-md-none "
                : "Icon  d-md-none"
            }
          ...
          {searchBox && <Searchbox setsearchBox={setsearchBox} buttonRef={buttonRef}/>}
        </div>

        <div className="NavbarMenu justify-content-around align-items-center d-none d-md-flex">
          <NavLink
            to="/"
            className={activeIndex === 1 ? "Icon activate" : "Icon"}
          ...
          <NavLink
            to="/video"
            id="videoicon"
            className={activeIndex === 2 ? "Icon activate" : "Icon"}
          ...
          <NavLink
            to="/marketplace"
            className={activeIndex === 3 ? "Icon activate" : "Icon"}
          ...
          <NavLink
            to="/groups"
            className={activeIndex === 4 ? "Icon activate" : "Icon"}
          ...
          <NavLink
            ...
            className={
              activeIndex === 5
                ? "Icon activate d-none d-lg-block "
                : "Icon d-none d-lg-block"
            }
            onClick={() => handleItemClick(5)}
          >
            {activeIndex === 5 ? (
        ...
        <div className="notificationIcon d-flex justify-content-end align-items-center col-6 col-md-3">
          <div className="allNotificationIcons d-flex justify-content-between  align-items-center">
            <NavLink className="nIcon d-none d-lg-block">
              <svg
                fill="currentColor"
                viewBox="0 0 44 44"
                width="1.3em"
            ...
            <NavLink className="nIcon d-none d-md-block d-lg-none">
              <svg
                fill="currentColor"
                viewBox="0 0 20 20"
                width="1em"
            ...
            <NavLink
              className={showMessagebox ? "nIcon activateicon" : "nIcon"}
              onClick={() => {
            ...
            <NavLink
              className={showNotification ? "nIcon activateicon" : "nIcon"}
            ...
            to='/profile'
              ...
              className="nIcon overflow-hidden position-relative"
            >
              <img
                src={profile}
                alt=""
          ...
          {showNotification && <NotificationBox buttonRef={buttonRef} />}
        </div>
      </nav>
    </>
  );
