...
export const Comments = () => {
  return (
    <div className="comments ">
      <div className="likeCommentsDetails d-flex justify-content-between pb-2">
        ...
        <div className="d-flex align-items-center ">
          ...
          <i
            ...
            style={{
              backgroundImage:
                "url(https://static.xx.fbcdn.net/rsrc.php/v3/yF/r/Rky7-HAnmw9.png)",
      ...
      <div className="likeCommentShare d-flex justify-content-around pt-2">
        <div className="like d-flex align-items-center">
          <i
            ...
            style={{
              backgroundImage:
                "url(https://static.xx.fbcdn.net/rsrc.php/v3/yD/r/vr9TZvjDY2K.png)",
